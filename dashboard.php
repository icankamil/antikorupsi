				...
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Dashboard</strong> Anti-Korupsi</h3>
						</div>
							...
							<div class="w-100">
								<div class="row">
									<div class="col-sm-12">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Jumlah Responden</h5>
										...
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Nilai</h5>
						...
						<div class="col-xl-6 col-xxl-7">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Responden Terakhir</h5>
								</div>
