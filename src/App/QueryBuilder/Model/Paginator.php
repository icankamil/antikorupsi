...
class Paginator extends Query
{
    ...
    public function links()
    {
        ...
        if ($this->number_of_page > 1) {
            ...
            $template .= "<ul class=\"pagination float-right\">
<li class=\"page-item " . ($this->current_page - 1 == 0 ? 'disabled' : '') . "\"><a class=\"page-link\" href=\"?page=" . (intval($this->current_page) - 1) . "&" . $this->queryString . "\">Previous</a></li>";
